...
module Kemal::Support
  ENCRYPT_ENV = "KEMAL_ENCRYPTION_KEY"
  FILE_PATH   = "./.encryption_key"

  module FileEncryptor
    def self.read(filename : String, encryption_key = self.encryption_key)
      encryptor = Kemal::Support::MessageEncryptor.new(encryption_key)
    ...
    def self.encryption_key(file = FILE_PATH)
      ...
      raise Kemal::Exceptions::EncryptionKeyMissing.new(file, ENCRYPT_ENV)
    end
  end
end