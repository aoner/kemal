module Kemal
  module WebSockets
    ...
    abstract struct ClientSocket
      ...
      protected getter raw_params : Kemal::Router::Params
      protected getter params : Kemal::Validators::Params
      protected getter session : Kemal::Router::Session::AbstractStore?
      protected getter cookies : Kemal::Router::Cookies::Store?
      ...
      def initialize(@socket, @context)
        ...
        @params = Kemal::Validators::Params.new(@raw_params)
        @socket.on_pong do
          @pongs.push(Time.utc)
