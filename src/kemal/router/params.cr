...
module Kemal::Router
  module Types
    ...
    alias Files = Hash(String, Kemal::Router::File)
    alias Params = Hash(String, String)
  end

  class Params
    TYPE_EXT_REGEX   = Kemal::Support::MimeTypes::TYPE_EXT_REGEX
    ...
    def [](key : Types::Key) : String
      self.[key]? || raise Kemal::Exceptions::Validator::InvalidParam.new(key)
    end
