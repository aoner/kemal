module Kemal::Validators
  ...
  class BaseRule
    ...
    def apply(params : Kemal::Router::Params)
    ...
    private def call_predicate(params : Kemal::Router::Params)
      @value = params[@field]
  ...
  class Params
    getter raw_params : Kemal::Router::Params
    ...
    def validate!
      ...
      raise Kemal::Exceptions::Validator::ValidationFailed.new errors
    end
